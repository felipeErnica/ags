 ...
 */
function setVerticalPosition(dropdownEventBox: EventBox, monitorHeight: number): void {
 ...
 */
export const calculateMenuPosition = async (positionCoordinates: number[], windowName: string, barHeight: number): Promise<void> => {
    try {
        ...
        setVerticalPosition(dropdownEventBox, finalHeight);
    } catch (caughtError) {
